...
|`aap_configuration_collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to Decision Environment creation in EDA, instead of failing on the first error.||
...
|:---:|:---:|:---:|:---:|
|`eda_configuration_decision_environments_secure_logging`|`false`|no|Whether or not to include the sensitive Registry role tasks in the log.  Set this value to `true` if you will be providing your sensitive values from elsewhere.|
...
|`eda_configuration_decision_environments_secure_logging`|`aap_configuration_async_retries`|no|This variable sets the number of retries to attempt for the role.|
|`aap_configuration_async_delay`|1|no|This sets the delay between retries for the role globally.|
|`eda_configuration_decision_environments_async_retries`|`aap_configuration_async_delay`|no|This sets the delay between retries for the role.|
|`aap_configuration_loop_delay`|1000|no|This variable sets the loop_delay for the role globally.|
|`eda_configuration_decision_environments_async_delay`|`aap_configuration_loop_delay`|no|This variable sets the loop_delay for the role.|
