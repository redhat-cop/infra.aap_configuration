...
|`collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to Decision Environment creation in EDA, instead of failing on the first error.||
