# redhat_cop.ah_configuration.ee_repository_sync
...
|`ah_ee_repositories`|`see below`|yes|Data structure describing your ee_repositories, described below. (Note this is the same as for the `ee_repositories` role and the variable can be combined||
