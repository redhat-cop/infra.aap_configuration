...
| `assign_galaxy_credentials_to_org`     | `true`        | no       | Boolean to indicate whether credentials should be assigned or not. Credentials must exist before adding. Set at the playbook level to override the dispatch two-pass behavior.                                                                                |           |
| `assign_default_ee_to_org`             | `true`        | no       | Boolean to indicate whether default execution environment should be assigned or not. EE must exist before adding. Set at the playbook level to override the dispatch two-pass behavior.                                                                       |           |
| `assign_notification_templates_to_org` | `true`        | no       | Boolean to indicate whether notification templates should be assigned or not. Templates must exist before adding. Set at the playbook level to override the dispatch two-pass behavior.                                                                       |           |
| `assign_instance_groups_to_org`        | `true`        | no       | Boolean to indicate whether an instance group should be assigned or not. Instance group must exist before adding. Set at the playbook level to override the dispatch two-pass behavior.                                                                       |           |
