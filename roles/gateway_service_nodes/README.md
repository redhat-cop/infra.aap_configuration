...
|`aap_configuration_collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to gateway service node configuration, instead of failing on the first error.||
