...
|`collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to host creation, modification, or deletion, instead of failing on the first error.||
