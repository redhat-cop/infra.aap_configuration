...
|`controller_configuration_inventory_source_update_async_retries`|30|no|This variable sets the number of retries to attempt for the role.|
|`controller_configuration_async_delay`|1|no|This sets the delay between retries for the role globally.|
|`controller_configuration_inventory_source_update_async_delay`|1|no|This sets the delay between retries for the role.|
