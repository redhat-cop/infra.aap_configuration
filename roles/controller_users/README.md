...
|`aap_configuration_collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to user creation, modification, or deletion, instead of failing on the first error.||
