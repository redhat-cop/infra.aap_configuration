...
|`collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to hub ee repository creation, instead of failing on the first error.||
