...
|`collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to gateway non-API routes configuration, instead of failing on the first error.||
