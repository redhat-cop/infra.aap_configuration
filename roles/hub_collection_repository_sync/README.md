...
|`collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to hub collection repository sync, instead of failing on the first error.||
