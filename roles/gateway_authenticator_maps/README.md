...
|`collect_logs`|`false`|no|Specify whether it collects logs for all failed tasks related to gateway authenticator map creation, instead of failing on the first error.||
