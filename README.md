...
You can install the infra.controller_configuration collection with the Ansible Galaxy CLI (Note that you will need to set up authentication access to Automation Hub):
